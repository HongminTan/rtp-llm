...
def init_engine_group_args(parser, runtime_config):
    ...
    # Fields merged from EngineConfig to RuntimeConfig (warm_up, warm_up_with_loss, enable_accuracy_check)
    ##############################################################################################################
    ...
    engine_group.add_argument(
        ...
        env_name="ENABLE_ACCURACY_CHECK",
        bind_to=(runtime_config, "enable_accuracy_check"),
        type=str2bool,
        default=False,
        help="在服务启动时是否开启精度检查",
    )
